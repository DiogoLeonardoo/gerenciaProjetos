...
public class CompromissoResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new compromissoDTO, or with status {@code 400 (Bad Request)} if the compromisso has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated compromissoDTO,
     * or with status {@code 400 (Bad Request)} if the compromissoDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the compromissoDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    ...
    /**
     * {@code PATCH  /compromissos/:id} : Partial updates given fields of an existing compromisso, field will ignore if it is null
     *
     * @param id the id of the compromissoDTO to save.
     * @param compromissoDTO the compromissoDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated compromissoDTO,
     * or with status {@code 400 (Bad Request)} if the compromissoDTO is not valid,
     * or with status {@code 404 (Not Found)} if the compromissoDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the compromissoDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of compromissos in body.
     */
    @GetMapping("")
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the compromissoDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
